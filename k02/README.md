...
l78 Node型でポインタ変数topを定義して何も入れない.
l79 Node型でpNodeを定義してmalloc関数でNode型1つ分のアドレスを確保する.
l80 pNodeのメンバ変数cityにnewCityを代入する.
l80 pNodeのメンバ変数pNextにpNexを代入する.
pNodeを返す.
