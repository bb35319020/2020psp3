...
## ソースコードの説明
l71　keyと一致しているかどうかをfor分で先頭から1つ1つ検証していく.
iと一致したら、構造体に格納されているidの配列indexを返す.
l73 iと一致するものを見つけたら-1を返す.

l80 centerに探索対象リストの中央の値を入れる.
centerがkeyを指したらその値をresultに入れる.centerよりkeyが右にあればcenterに+1をしてleftに代入する.
centerよりkeyが左にあれば、cnterを-1をしてrihgtに代入する.
l82探索対象をだんだんと絞っていく中で,rightとleftが交差するところまで繰り返す.それはすなわち探索対象リストを右側と左側からすべて探索したことを意味する.
## 出力結果
